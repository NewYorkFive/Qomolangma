...
#import "QLMVideoViewController.h"
...
@interface QLMVideoViewController ()
...
@implementation QLMVideoViewController

+ (instancetype)sharedVideoViewController{
    static QLMVideoViewController *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[QLMVideoViewController alloc]init];
...
- (void)playButtonClick:(UIButton *)sender{
    ...
    QLMVideoModel *tempModel = [[QLMVideoModel alloc]init];
    tempModel.title = @"Hello,Girls";
    [self.playListVideoArray addObject:tempModel];
...
- (NSMutableArray<QLMVideoModel *> *)playListVideoArray{
    if (!_playListVideoArray) {
        _playListVideoArray = [NSMutableArray array];
    }
    return _playListVideoArray;
